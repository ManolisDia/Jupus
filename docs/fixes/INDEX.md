...
| 2026-08-24 | [2026-08-24-011.md](2026-08-24-011.md) | Every latency stat since Phase 6a silently read as zero — `processing_latency_percentiles` looked for a `user_message` trace event that was never actually emitted; replaced with a real four-stage breakdown in Phase 11 |
